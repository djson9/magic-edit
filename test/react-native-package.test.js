...
describe('@djson9/magic-edit React Native distribution', () => {
  it('ships a compiled component and the autolinked iOS implementation', () => {
    ...
    expect(bundle).toContain('Keep updates active in background')
    expect(bundle).toContain('setBackgroundUpdatesEnabled')
    ...
    expect(podspec).toContain("spec.frameworks = 'AVFoundation'")
    ...
    expect(swift).toContain('UIBackgroundModes')
    expect(swift).toContain('DJSON9MagicEditBackgroundUpdatesEnabled')
