...
__export(testing_exports, {
  getMagicEditDiagnosticSnapshot: () => getMagicEditDiagnosticSnapshot,
  registerMagicEditAppMetadata: () => registerMagicEditAppMetadata,
  resetMagicEditDiagnostics: () => resetMagicEditDiagnostics,
  setMagicEditDiagnosticClock: () => setMagicEditDiagnosticClock
});
...
// redux/testing.ts
function resetMagicEditDiagnostics() {
  diagnosticRuntime().resetForTests();
}
function setMagicEditDiagnosticClock(clock) {
  diagnosticRuntime().setClockForTests(clock);
}
function getMagicEditDiagnosticSnapshot() {
  return diagnosticRuntime().snapshot();
}
function registerMagicEditAppMetadata(metadata) {
