...
<script
  type="module"
  src="https://cdn.jsdelivr.net/gh/djson9/magic-edit@v0.4.1/dist/magic-edit.js">
</script>
...
```sh
npm install @djson9/magic-edit@0.4.1
```
...
```yaml
- uses: djson9/magic-edit/.github/actions/deploy@v0.4.1
  with:
    target: my-app
```
